...
class Update extends CI_Controller {
	...
	public function investigation(){
			...
			$this->updating->investigations($InvestigationId,$InvestigationName,$InvestigationFee,$InvestigationAvailability,$InvestigationSummary);
	}
	...
	public function doctor(){
			...
			$this->Saving->doctor($DoctorFirstName,$DoctorLastName,$DoctorMobileNo,$DoctorPhoneNo,$DoctorAddress,$DoctorCity,$DoctorPinCode,$DoctorState,$DoctorSpecialist,$DoctorComments); 
	}
